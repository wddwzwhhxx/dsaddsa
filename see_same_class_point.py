...
if __name__ == '__main__':
    ...
    for i in range(len(all_result)):
        ...
        for j in range(1,len(result)):
            ...
            if (side1 ==1 or side1 ==2) and (side2 ==1 or side2 ==2):
                side_a=1
                side_b=1
            elif (side1 ==3 or side1 ==4) and (side2==3 or side2==4):
                side_a=2
                side_b=2
            else:
                side_a=255
            ...
            if abs(cls_a-cls_b)==2:
                print('shit!')
            ftrainval.write(str(y1)+' '+str(x1)+' '+str(cls_a)+' '+str(side_a)+' '+str(y2)+' '+str(x2)+' '+str(cls_b)+' '+str(side_b)+'\n')
